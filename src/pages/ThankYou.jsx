  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 animate-fadeIn">
      <div className="max-w-lg w-full text-center">
        {/* Success Icon */}
        <div className="mb-8">
          <div className="w-24 h-24 md:w-32 md:h-32 bg-green-100 rounded-full flex items-center justify-center mx-auto animate-pulse-slow">
            <svg 
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10">
          ...
          <p className="text-gray-600 text-lg mb-6 leading-relaxed">
            شكراً لثقتكم بنا. سنتصل بكم قريباً لتأكيد الطلبية وترتيب التوصيل.
          </p>
          ...
          <div className="bg-blue-50 rounded-2xl p-5 mb-6">
            <div className="flex items-center justify-center gap-3 text-blue-600">
              ...
              <span className="font-medium">سنتصل بكم خلال 24 ساعة</span>
            </div>
          </div>

          {/* What's Next */}
          <div className="text-right mb-8">
            <h3 className="font-bold text-gray-800 mb-4">ماذا بعد؟</h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-600">سنتصل بكم لتأكيد الطلب والعنوان</p>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold">
                  2
                </div>
                <p className="text-gray-600">سنقوم بتجهيز طلبكم وشحنه</p>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-6 h-6 bg-green-500 text-white rounded-full flex items-center justify-center flex-shrink-0 text-sm font-bold">
                  3
                </div>
                <p className="text-gray-600">ستستلمون طلبكم وتدفعون عند الاستلام</p>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 flex justify-center gap-6 text-gray-400">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">موثوق</span>
          </div>
        </div>
      </div>
    </div>
